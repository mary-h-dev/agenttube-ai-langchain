...
// SSE Constants (ثابت‌های مربوط به SSE)
export const SSE_DATA_PREFIX = "data: " as const; // پیشوند داده‌های ارسال شده در SSE
export const SSE_DONE_MESSAGE = "[DONE]" as const; // پیغام پایان برای نشان دادن تمام شدن جریان
export const SSE_LINE_DELIMITER = "\n\n" as const; // جداکننده‌ی خطوط در پیام‌های SSE
