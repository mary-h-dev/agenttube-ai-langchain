...
function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 top-14 bottom-0 left-0 z-50 w-72 bg-gray-50/80 backdrop-blur-xl border-r border-gray-200/50 transform transition-transform duration-300 md:relative md:translate-x-0 md:top-0 flex flex-col",
